...
export default function HomePage() {
  return (
    <main className="bg-background text-foreground mx-auto flex min-h-dvh w-full max-w-2xl flex-col justify-center gap-8 px-6 py-16">
      <div className="space-y-3">
        ...
        <p className="text-muted-foreground text-base leading-relaxed">
          Auth, oRPC, Drizzle, Supabase, and TanStack Query conventions — plus a
          delete-able <code className="text-foreground">modules/example</code>{' '}
          CRUD demo.
        </p>
      </div>
